...
export default function HomePage() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-blue-100 to-white px-4 sm:px-8">
      <div className="bg-white rounded-2xl shadow-2xl sm:p-100  lg:p-100 max-w-4xl w-full h-[60vh] flex flex-col justify-between text-center items-center">
<div >
 <svg
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    />
        ...
        <p className="text-sm text-gray-400 sm:mb-4">
