    ...
    return (
      <div className="p-6 max-w-6xl mx-auto grid grid-cols-1 gap-y-2">
        ...
        <Link
          ...
          className="flex bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 text-sm mb-4 w-3xs justify-self-center justify-center"
        >
          🔥 Student's HOTS Scores
        </Link>

        {/* Filter */}
        <div className="flex gap-4 mb-4 items-center text-black ">
          <div>
            <label className="text-sm font-medium">Chapter Filter :</label>
            <select
              value={chapter}
          ...
          <div>
            <label className="text-sm font-medium">Students Filter :</label>
            <select
